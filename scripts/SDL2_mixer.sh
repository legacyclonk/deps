...
cmake .. -DBUILD_SHARED_LIBS=Off -DSDL_MIXER_ENABLE_OGGVORBIS=On -DSDL_MIXER_ENABLE_NATIVEMIDI=On -DSDL_MIXER_ENABLE_MOD=On -DSDL_MIXER_ENABLE_MP3=On $OS_OPTIONS $CMAKE_CONFIGURE_ARGS
